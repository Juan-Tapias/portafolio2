...
const ProjectCarousel: React.FC<ProjectCarouselProps> = ({ projects }) => {
  ...
  return (
      <div className="relative w-full h-screen bg-gray-900">  <Swiper
        ...
        <div className="absolute bottom-6 right-6 flex space-x-3 z-50">
          {projects.map((project, idx) => (
            <div
              key={idx}
              className={`w-24 h-16 rounded-lg overflow-hidden cursor-pointer transition-all duration-500
